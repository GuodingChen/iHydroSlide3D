module CREST_Project
   ...
   integer :: g_TimeStep
   integer(kind=8) :: g_TimeStepToSeconds
   character(len=19), allocatable :: SimuDateTimeList(:)  ! time format is like: 2012-07-02 01:00:00

   character(len=50) :: StartDateTime_simu, EndDateTime_simu, WarmupDateTime_simu
   
   ! character(len=50) :: g_StartDate, g_EndDate, g_WarmupDate
